...
import br.eti.observation.persistence.payload.response.DTOResponseStationOnShore;
import br.eti.observation.persistence.repository.RepositoryStationOnShore;
