...
import br.eti.observation.persistence.payload.response.DTOResponseSynopticObservation;
import br.eti.observation.persistence.payload.response.DTOResponseSynopticObservationHistoric;
import br.eti.observation.persistence.payload.response.DTOResponseSynopticObservationHistoricOffShore;
import br.eti.observation.persistence.payload.response.DTOResponseSynopticObservationHistoricOnShore;
import br.eti.observation.persistence.repository.*;
