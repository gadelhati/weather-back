...
public class ControllerStationCategory implements ControllerInterface<DTOResponseStationCategory, DTORequestStationCategory> {
    ...
    public ResponseEntity<Page<DTOResponseStationCategory>> retrieve(@RequestParam(name = "key", defaultValue = "", required = false) String key, @RequestParam(name="value", defaultValue = "", required = false) String value, Pageable pageable){
