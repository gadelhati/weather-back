...
public class ControllerPlatform implements ControllerInterface<DTOResponsePlatform, DTORequestPlatform> {
    ...
    public ResponseEntity<Page<DTOResponsePlatform>> retrieve(@RequestParam(name = "key", defaultValue = "", required = false) String key, @RequestParam(name="value", defaultValue = "", required = false) String value, Pageable pageable){
