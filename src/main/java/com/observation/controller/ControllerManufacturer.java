...
public class ControllerManufacturer implements ControllerInterface<DTOResponseManufacturer, DTORequestManufacturer> {
    ...
    public ResponseEntity<Page<DTOResponseManufacturer>> retrieve(@RequestParam(name = "key", defaultValue = "", required = false) String key, @RequestParam(name="value", defaultValue = "", required = false) String value, Pageable pageable){
