...
public class ControllerSurveying implements ControllerInterface<DTOResponseSurveying, DTORequestSurveying> {
    ...
    public ResponseEntity<Page<DTOResponseSurveying>> retrieve(@RequestParam(name = "key", defaultValue = "", required = false) String key, @RequestParam(name="value", defaultValue = "", required = false) String value, Pageable pageable){
