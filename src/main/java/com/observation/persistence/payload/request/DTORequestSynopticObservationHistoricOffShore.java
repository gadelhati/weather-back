...
@ValidNhCLCM @ValidTTTTdTdTd @ValidAppp
@ValidCLCM @ValidCMCH @ValidNCLCMCH
@ValidNCLCMCHh @ValidNddff @ValidNh @ValidNhCLCMCHh @ValidNhCLCMh @ValidNNh @ValidNW2 @ValidTTTTnTnTn @ValidTTT
@ValidTxTxTx
@ValidVVh @ValidVVWW
@ValidW1W2
public class DTORequestSynopticObservationHistoricOffShore {
